...
};
{
  ...
  window.RuntimeInterface = class e {
    ...
    async #M(e) {
      ...
      this.#e ? await this.#N(e, t.port2) : await this.#G(e, t.port2)
    }
    #F(t) {
      return {
    ...
    L = class extends self.DOMHandler {
      constructor(e) {
        ...
        if (window.addEventListener("contextmenu", e => {
          ...
          }), window.addEventListener("mousewheel", R, {
            passive: !1
      ...
      _AddDefaultHTMLWrapEventHandlers(e) {
        e.addEventListener("selectstart", I), e.addEventListener("gesturehold", I), e.addEventListener("touchstart", I), e.addEventListener("dragstart", I)
      }
  ...
  function U() {}
  window.addEventListener("beforeinstallprompt", e => (e.preventDefault(), N = e, G && G._OnBeforeInstallPrompt(), !1));
  const H = "browser",
    W = class extends self.DOMHandler {
      ...
      Attach() {
        N ? this._OnBeforeInstallPrompt() : G = this, window.addEventListener("appinstalled", () => this._OnAppInstalled())
      }
      ...
      async _OnRequestInstall() {
        ...
        try {
          return N.prompt(), {
            result: (await N.userChoice).outcome
          }
        } catch (e) {
          ...
          ! function(t) {
            ...
            function c(e, l, c) {
              var b = l ? 0 : 4,
                ...
                R = "is" + e,
                O = "_" + R;
              return I.buffer = void 0, I.offset = 0, I[O] = !0, I.toNumber = x, I.toString = function(e) {
                var t = this.buffer,
                  i = this.offset,
                  n = D(t, i + b),
                  r = D(t, i + S),
                ...
                return o && (s = "-" + s), s
              }, I.toJSON = x, I.toArray = u, r && (I.toBuffer = h), s && (I.toArrayBuffer = p), M[R] = function(e) {
                return !(!e || !e[O])
              }, t[e] = M, M;
...
});
{
  ...
  self.RuntimeInterface.AddDOMHandlerClass(ve)
} {
  const we = "list";
  ...
  const Se = class extends self.DOMElementHandler {
    ...
    CreateElement(e, t) {
      ...
      return s.addEventListener("pointerdown", be), s.addEventListener("pointerrawupdate", be), s.addEventListener("pointerup", be), s.addEventListener("mousedown", be), s.addEventListener("mouseup", be), s.addEventListener("click", t => {
  ...
  const Te = "video",
    Ee = class extends self.DOMElementHandler {
      constructor(e) {
        super(e, Te), this.SetAutoAttach(!1), this._isRuntimeInWorker = !1, this._supportsRvfc = !1, this._postImageBitmaps = !1, this._sequenceNumber = 0, this._numVideos = 0, this._destroyedVideos = new WeakSet, this.AddRuntimeMessageHandler("init", e => this._OnInit(e)), this.AddDOMElementMessageHandlers([
      ...
      UpdateState(e, t) {}
      DestroyElement(e) {
        this.RemovePendingPlay(e), ke(e) && e.pause(), e.src = "", this._numVideos = Math.max(this._numVideos - 1, 0), 0 === this._numVideos && this._StopTicking(), this._destroyedVideos.add(e)
      }
      _OnPlay(e) {
        this.TryPlayMedia(e)
      }
